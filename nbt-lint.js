        ...
        while (true) {
          ...
          if (currValue.constructor !== array.type) {
            throw this.exception(
              "Unable to insert " + currValue.tagName + " into " + array.tagName
            );
          }
